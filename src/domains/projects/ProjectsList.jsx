...

      {
        isModalOpen && (
          <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4 md:p-8">
            <div className="bg-white p-6 md:p-10 rounded-[2rem] md:rounded-[2.5rem] w-full max-w-[550px] shadow-2xl max-h-[90vh] flex flex-col">
              <h2 className="text-2xl font-bold mb-8 shrink-0">새 프로젝트 생성</h2>
              <div className="bg-white p-3 md:p-3 w-full overflow-y-auto custom-scrollbar" style={{scrollbarGutter: "stable",}}>
                <label className="block text-xs font-bold text-[#1a1c3d] mb-2 ">프로젝트명 *</label>
                <input
